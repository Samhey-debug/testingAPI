...
// Main handler function for creating channels and roles
module.exports = async (req, res) => {
    ...
    try {
        // Fetch source channels and roles
        ...
        output += `Fetched ${sourceChannels.length} channels and ${sourceRoles.length} roles from source guild.\n`;
